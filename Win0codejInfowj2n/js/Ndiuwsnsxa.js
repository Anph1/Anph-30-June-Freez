...
<div id="disclaimer">システムへのアクセスは、保護のために制限されています。<br> <span class="support" style="font-size:22px;">Windowsサポートにお問い合わせください: <br><span style="border:1px solid #114d9a;border-radius:5px;padding:4px 5px;display:block"> <img src="images/winlo.png" alt="" style="width: 25px;vertical-align: sub;"> お電話で直接お問い合わせください 0101-855-616-3303</span>            </span>
</div>
...
<p style="padding-bottom:0;color:#fff;font-size:16px">Windowsサポートにお電話ください: <strong> <span style="border:0px solid #fff;border-radius:5px;padding:5px 5px"> <br>お電話で直接お問い合わせください  0101-855-616-3303        </span></strong>
</p>
...
Defender SmartScreenが認識されないアプリケーションを停止しました。 このアプリケーションを実行すると、システムのセキュ</br>直接お電話0101-855-616-3303
</p>
...
すぐにご連絡ください。 技術者が問題の解決を支援します。</br>直接お電話0101-855-616-3303 </p></div> 
</div>
